...
aws s3 cp s3://codedeploystack-webappdeploymentbucket-lscfffupw1af/client /usr/local/client --recursive
# cd /usr/local/server
aws s3 cp s3://codedeploystack-webappdeploymentbucket-lscfffupw1af/server /usr/local/server --recursive
aws s3 cp s3://codedeploystack-webappdeploymentbucket-lscfffupw1af/.env /usr/local/server 
